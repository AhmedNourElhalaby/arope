...
export class FaweryService {
    ...
    let total_price = localStorage.getItem('total_price');
      ...
      let successPageUrl = '';
      if(key == 'travel') {
         successPageUrl = 'http://207.154.195.214/arope/traveler-insurance/traveler-info?step=thankyou';
      } else {
        successPageUrl = 'http://207.154.195.214/arope/personal-accident/personal-result?step=thankyou';
